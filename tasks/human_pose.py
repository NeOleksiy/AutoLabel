...
class HumanPoseKeypointTask:
    ...
    def __init__(self, logger,
        ...
        self.task_config = TaskConfig(
            ...
            description="Detect human poses with keypoints",
    ...
    def _init_model(self):
        try:
            self.logger.info("Initializing HumanPoseKeypointTask model...")
            ...
            self.logger.info("HumanPoseKeypointTask initialized successfully")
            
        except Exception as e:
            self.logger.error(f"Error initializing HumanPoseKeypointTask: {e}")
            raise RuntimeError(f"Error initializing HumanPoseKeypointTask: {e}")
